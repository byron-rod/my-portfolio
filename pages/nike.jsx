    ...
    <div className="w-full h-full bg-[#1c1b20] overflow-x-hidden scrollbar scrollbar-track-[#1c1b20] scrollbar-thumb-gray-400">
      <div className="w-screen h-[50vh] relative">
        ...
        <Image
          ...
          src={nikeImg}
          alt="screen shot of nike website"
          quality={20}
          onClick={openModal}
        />
      ...
      <div className="max-w-[1240px] md:mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 mx-3">
        <div className="col-span-4 text-gray-300">
          ...
          <p>
            ...
            Nike e-commerce front-end was created using all the best practices
            for React and TailwindCSS.
          </p>
          <a
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="link to live webiste demo"
          >
