    ...
    <div className="w-full bg-[#1c1b20] overflow-x-hidden scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#1c1b20]">
      <div className="w-screen h-[50vh] relative scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#1c1b20]">
        ...
        <Image
          ...
          src={brainwave}
          alt="screen shot of brainwave website"
          quality={25}
          onClick={openModal}
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2 text-3xl font-semibold">Brainwave AI</h2>
      ...
      <div className="max-w-[1240px] md:mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 mx-3">
        <div className="col-span-4 text-gray-300">
          ...
          <p>
            This is a landing page for a SaaS AI product that exemplifies modern
            UI/UX principles with animations and bento grids in the design. The
            website is built with Vite and React.JS, Tailwind CSS, and Parallax
            for animations. The website is fully responsive. The website is
            hosted on Vercel.
          </p>
          <a
            href="https://github.com/byron-rod/brainwave"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://brainwave-navy.vercel.app/"
            target="_blank"
            rel="noreferrer"
        ...
        <div className="col-span-4 lg:col-span-1 shadow-xl shadow-gray-800 rounded-xl py-4 bg-[#cabca3]/80 mx-3">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-black-600 py-2 flex items-center ml-3">
                <RiRadioButtonFill className="pr-1" /> Parallax Animations
              </p>
              <p className="text-black-600 py-2 flex items-center ml-3">
