    ...
    <div className="w-full bg-[#1c1b20]">
      <div className="w-screen h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2 text-2xl">Netflix and Chill</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4 text-gray-500">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <button className="px-8 py-2 mt-4 mr-8 bg-gray-400 rounded-xl">
              Code
            </button>
          </a>
          <a
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-black-400 rounded-xl py-4 bg-gray-300">
          <div className="p-2">
